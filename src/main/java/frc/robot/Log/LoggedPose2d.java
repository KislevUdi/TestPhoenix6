...
/** Add your docs here. */
public class LoggedPose2d extends Pose2d {
  private LoggedTranslation2d m_translation;
  private LoggedRotation2d m_rotation;

  /** Constructs a pose at the origin facing toward the positive X axis. */
  public LoggedPose2d(String name) {
    this(name,new Translation2d(),new Rotation2d());
  }
   ...
   */
  public LoggedPose2d(String name, Translation2d translation,Rotation2d rotation) {
    m_translation = new LoggedTranslation2d(name+ "/translation", translation.getX(), translation.getY());
    m_rotation = new LoggedRotation2d(name, rotation.getRadians());
  }
   ...
   * @param rotation The rotational component of the pose.
   */
  public LoggedPose2d(String name, double x, double y, Rotation2d rotation) {
    this(name, new Translation2d(x, y),rotation);
  }
   ...
   * @param rotation The rotational component of the pose.
   */
  public LoggedPose2d(String name, Measure<Distance> x, Measure<Distance> y, Rotation2d rotation) {
    this(name, x.in(Units.Meters), y.in(Units.Meters), rotation);
  }

  public void set(Pose2d pose) {
    m_rotation.set(pose.getRotation());
    m_translation.set(pose.getTranslation());
  }
  ...
  public void  mult(double scalar) {
    m_translation.mult(scalar);
    m_rotation.mult(scalar);
  }
  ...
  public void rotate(Rotation2d other) {
    m_translation.rotate(other);
    m_rotation.rotate(other);
  }
  ...
  public void transform(Transform2d other) {
        m_translation.add(other.getTranslation().rotateBy(m_rotation));
        m_rotation.add(other.getRotation());;
  }
  ...
  public boolean equals(Object obj) {
    if (obj instanceof Pose2d) {
      Pose2d p = (Pose2d) obj;
      return p.getTranslation().equals(m_translation)
          && p.getRotation().equals(m_rotation);
    }
    return false;
  }
