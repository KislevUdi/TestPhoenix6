...
/** Add your docs here. */
public class LoggedRotation2d extends Rotation2d {
  private double m_value = 0;
  private double m_cos = 1;
  private double m_sin = 0;

  /** Constructs a Rotation2d with a default angle of 0 degrees. */
  public LoggedRotation2d(String name) {
    this(name,0);
  }
   ...
   */
  public LoggedRotation2d(String name, double radians) {
    set(radians);
    LogManager.addEntry(name, this::getDegrees);
  }
   ...
   */
  public LoggedRotation2d(String name, double x, double y) {
    setXY(x, y);
    LogManager.addEntry(name, this::getDegrees);
  }
  ...
  public void setXY(double x, double y)  {
    ...
    if (magnitude > 1e-6) {
      set(m_sin = y / magnitude, m_cos = x / magnitude);
    } else {
      set(0,1);
    }

  }
  public void set(double sin, double cos) {
    set(Math.atan2(m_sin, m_cos),sin,cos);
  }
  private void set(double radians, double sin, double cos) {
    m_cos = cos;
    m_sin = sin;
    m_value = radians;
  }

  public void set(Rotation2d rotation) {
    set(rotation.getRadians(), rotation.getSin(), rotation.getCos());
  }
   ...
   */
  public LoggedRotation2d(String name, Measure<Angle> angle) {
    this(name, angle.in(edu.wpi.first.units.Units.Radians));
  }
   ...
   */
  public static LoggedRotation2d fromRadians(String name, double radians) {
    return new LoggedRotation2d(name, radians);
  }
   ...
   * @return The rotation object with the desired angle value.
   */
  public static LoggedRotation2d fromDegrees(String name, double degrees) {
    return new LoggedRotation2d(name, Math.toRadians(degrees));
  }
   ...
   * @return The rotation object with the desired angle value.
   */
  public static LoggedRotation2d fromRotations(String name, double rotations) {
    return new LoggedRotation2d(name,Units.rotationsToRadians(rotations));
  }
  ...
  public void substract(Rotation2d other) {
    rotate(other.unaryMinus());
  }
  ...
  public void rotate(Rotation2d other) {
    setXY(m_cos * other.getCos() - m_sin * other.getSin(), m_cos * other.getSin() + m_sin * other.getCos());
  }
